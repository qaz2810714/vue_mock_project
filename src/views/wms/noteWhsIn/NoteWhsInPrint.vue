   ...
   <div>
       <div class="cont" id="printDiv">
        ...
        <div class="contractInfor clearfix">
            <ul class="fl">
                <li><label>入库单号：</label><span>{{mainInfo.whsinCode}}</span></li>
                <li><label>仓库：</label><span>{{mainInfo.whsInfo.name}}</span></li>
                <li><label>入库时间：</label><span>{{mainInfo.createTime}}</span></li>
                <li><label>入库通知单号：</label><span>{{mainInfo.billAttachmentId}}</span></li>
            </ul>
            <ul class="fr">
                <li><label>货主单位：</label><span>{{mainInfo.cstId}}</span></li>
                <li><label>入库状态：</label><span>{{mainInfo.status}}</span></li>
                <li><label>制单人：</label><span>{{mainInfo.creatorName}}</span></li>
                <li><label>入库类型：</label><span>{{mainInfo.whsinStyle}}</span></li>
            </ul>
        </div>
