<template>
  <el-container>
    ...
    flex-direction: column;margin:2px 5px 0 0">
      <p style="text-align:left;padding-left:24px;margin: 9px 0;"><b>品类信息</b>
      <span>
        <el-button size="mini" title="新增品类" @click="addClass_func">新增</el-button>
    ...
    <el-container>
      <el-main style="padding: 0px;">
        ...
        <pm_table ref="pmTable" tableKey="BrandManage-pmTable" :dataSource="dataSource" :config="config">
          <pm_column prop="name" label="品名名称" width="200"></pm_column>
          <pm_column prop="id" label="品名代码" width="200"></pm_column>
...
import brandClsEdit from './BrandClsEdit';
...
export default {
  ...
  methods: {
    ...
    getSelectedClass:function(){
      ...
      if(node==null){
        this.$commonUtil.valid.throwEx("请选择一个品类节点");
      }
      return node;
    },
    //---------- 处理分类信息 begin -----------------------
    ...
    removeClass_func: function(deptNode) { 
      var entity =deptNode; 
      var $this = this;
      this.$commonUtil.message.confirm('确认删除选择的品类【'+ entity.name +'】吗?', function(){
